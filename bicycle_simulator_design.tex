...
assembly steer angle $\steer$, linearized about the zero roll and zero steer configuration
\begin{equation}
...
The kinematics of the bicycle can described with the following equations
